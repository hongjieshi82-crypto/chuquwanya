...
.pc-box-page .pc-box-action{position:fixed!important;inset:auto 20px calc(var(--mobile-bottom) + 10px) 20px!important;z-index:115!important;box-sizing:border-box;min-width:0;max-width:none;width:auto!important;margin:0!important;padding:14px!important;display:flex!important;flex-direction:column;align-items:stretch;gap:12px;border-radius:20px!important}.pc-box-summary{min-width:0;width:100%}.pc-box-page .pc-box-summary-value{display:block;overflow:hidden;font-size:13px!important;line-height:20px!important;text-overflow:ellipsis;white-space:nowrap!important}.pc-box-action-buttons,.pc-box-action-buttons .ant-space-item,.pc-box-start-button{width:100%!important}.pc-box-start-button{height:54px!important}
